...
export default function Bio() {
  return (
    <section
      id="About"
      className="flex flex-col px-12 py-24 md:px-24 lg:px-52 2xl:px-96 text-neutral-800 font-display"
    >
      <FadeUp>
        <span className="flex text-4xl font-medium w-max md:text-5xl lg:text-5xl shadow-bottom md:shadow-bottom2 lg:shadow-bottom3">
          About Me
        </span>
      </FadeUp>
      <FadeIn>
